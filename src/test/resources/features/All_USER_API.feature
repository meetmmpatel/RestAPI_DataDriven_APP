...
Feature: High Level Testing for User API
  ...
  Scenario Outline: Successfully Request and response validation of USER API methods
    ...
    Examples:
      ...
      | apiTest11@test.com   | UserOne   | Male   | Active | apiTest1101@test.com | Inactive       |
      | apiTest12@test.com   | UserTwo   | Female | Active | apiTest1102@test.com | Inactive       |
      | apiTest113@test.com  | UserThree | Male   | Active | apiTest1103@test.com | Inactive       |
      | apiTest1124@test.com | UserFour  | Female | Active | apiTest1124@test.com | Inactive       |
      | apiTest115@test.com  | UserFive  | Male   | Active | apiTest1105@test.com | Inactive       |
